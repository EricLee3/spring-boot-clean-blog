package com.ajin.comment;

import lombok.RequiredArgsConstructor;
import com.ajin.post.Post;
import com.ajin.post.PostRepository;
...
public class CommentController {
	...
	public String createComment(@ModelAttribute @Valid CommentDto commentDto, BindingResult bindingResult,
		...
		model.addAttribute("comment",
				commentService.createComment(new Comment(commentDto.getContent(), new Post(commentDto.getPostId()))));
